package cn.psw.youwenbida.api.utils;
...
//            return new BASE64Encoder().encode(encryptedData);
    ...
    public static String decrypt(String encrypted) {
        try {
            ...
            System.out.println("*****++++++——————————待解密内容："+encrypted);
            byte[] byteMi = Base64.decodeBase64(encrypted.getBytes());
            System.out.println("*****++++++-----------"+bytesToHexString(byteMi));
            IvParameterSpec zeroIv = new IvParameterSpec(VIPARA.getBytes());
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("请输入要加密的內容：");
        String content=scanner.next();
        String encodeContent=new String(encrypt(content));
        System.out.print("加密后：");
        System.out.println(encodeContent);
        String decodeContent=new String(decrypt(encodeContent));
