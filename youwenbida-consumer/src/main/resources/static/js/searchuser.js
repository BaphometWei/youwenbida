...
(function($) {
	$.searchuser = function (element, options) {
		...
		plugin.init = function () {
			...
			$(box_element).addClass('searchuser options-hidden');
			$(box_element).css({
				width: '388px',
			...
			$(i_element).addClass('layui-icon layui-icon-search topic-search-input');
			$(box_element).append(i_element);
