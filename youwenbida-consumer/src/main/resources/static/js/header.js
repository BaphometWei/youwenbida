...
function tiwen() {
    ...
    layui.use('layer', function () {
        ...
        layer.open({
            ...
            offset: '80px',
            btn: ['发布问题'],
            content: "<div class='tiwen'><div class='tiwen-header'><img class='Avatar AuthorInfo-avatar' style='cursor: pointer;' width='40' height='40' src='/img/touxiang.jpg' /><input type='text' placeholder='写下你的问题，准确地描述问题更容易得到解答'/></div><div id='tiwenedit'></div></div>",
            ...
            yes: function (index, layero) {
                ...
                alert(layedit.getContent(getText));
            }
        });
    });
}